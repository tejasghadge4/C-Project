...
//  Input           :  char arr[]   
//  Output          :  String
//  Description     :  Start the Application after entering correct password(Shubham)
//  Author          :  Tejas Ghadge
//  Date            :  16/07/2023
//
/////////////////////////////////////////////////////
...
void Authentication()
	...
	if(i==3)
	{
		printf("You Entered Wrong Password 3 times..Sorry!");
		exit(0);
	}
	...
	if(_stricmp(pass,"TejasG")==0)
	{
	printf("You Entered Correct Password..Welcome..!\n");
	}
