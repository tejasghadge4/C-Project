...
void man(char *name)
{
    ...
    {
        printf("Descrpition : Used to create new regular file\n");
...
int WriteFile(int fd, char *arr, int isize)
{
    ...
    if(((UFDTArr[fd].ptrfiletable->ptrinode->permission) != WRITE) && ((UFDTArr[fd].ptrfiletable->ptrinode->permission) != READ+WRITE))   return -2;
